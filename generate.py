...
POSTS = [
    ...
    dict(slug="graphic-hoodie-vs-graphic-tee", title="Graphic Hoodie vs. Graphic Tee: Which Fits Your Vibe?",
        ...
        body=[
            ...
            "Climate matters more than people admit. In consistently warm regions, tees will get more wear per dollar. Anywhere with a real cold season, a hoodie earns its price back faster because it replaces a jacket on mild days.",
    ...
    dict(slug="tohmee-size-guide", title="TōhMee Size Guide: Finding Your Perfect Fit",
        ...
        body=[
            ...
            "For international orders, our sizing follows standard US/UK unisex numbering, which tends to run one size larger than EU or Japanese labels for the same body measurement. As a rough guide by chest width: S is roughly 91-96cm, M is 101-106cm, L is 111-116cm, and XL is 121-126cm — use these centimeter ranges rather than the letter size alone if you're used to EU, JP, or CN sizing charts.",
    ...
    dict(slug="best-streetwear-colors-fall-winter", title="Best Streetwear Colors for Cold Weather",
        ...
        body=[
            ...
            "Mid layers (hoodies) work best in grounded, muted tones — charcoal, navy, heather grey, forest green — since they take up the most visual real estate in a cold-weather fit and loud colors here get tiring fast.",
